...
function tick() {
    ...
    container2.rotation.x += 0.02;
    container2.rotation.z += 0.01;
    container3.rotation.y -= 0.01;
    container3.rotation.z += 0.02
    container4.rotation.y += 0.01;
    container4.rotation.x -= 0.01;
    container4.rotation.z += 0.02;
    container5.rotation.y -= 0.01;
    container5.rotation.x -= 0.01
    container5.rotation.z += 0.01;
    container6.rotation.y += 0.02;
    container6.rotation.x -= 0.01;
    container6.rotation.z += 0.01;
    container7.rotation.y += 0.01;
    container7.rotation.x += 0.01;
    container7.rotation.z -= 0.02;
    container8.rotation.y += 0.01;
    container8.rotation.x += 0.01;
    container8.rotation.z += 0.01;
    container9.rotation.y += 0.01;
    container9.rotation.x -= 0.01;
    container9.rotation.z += 0.01;
    container10.rotation.y -= 0.01;
    container10.rotation.x += 0.01;
    container10.rotation.z += 0.01;
    container11.rotation.y -= 0.001;
    container11.rotation.x += 0.01;
    container11.rotation.z -= 0.01;
    container12.rotation.y += 0.01;
    container12.rotation.x += 0.01;
    container12.rotation.z += 0.05;
    container13.rotation.y += 0.01;
    container13.rotation.x += 0.01;
    container13.rotation.z += 0.03;
    container14.rotation.y += 0.01;
    container14.rotation.x += 0.01;
    container14.rotation.z += 0.01;
    container15.rotation.y -= 0.01;
    container15.rotation.x -= 0.01;
